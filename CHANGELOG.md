...
- **Quick timer from closed notch**: ⌥-click (or long-press when Open on hover is off) for three configurable minute presets; right-click menu includes the same shortcuts. Durations are editable in Timer settings.
