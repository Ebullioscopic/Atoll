...
final class AudioDeviceMonitor: AudioDeviceProviding {
    ...
    private let logger = os.Logger(subsystem: Bundle.main.bundleIdentifier ?? "FineTune", category: "AudioDeviceMonitor")
    ...
    private func refresh() {
        do {
            ...
            for deviceID in deviceIDs {
                ...
                // etc.) pass through.
                if deviceID.isAggregateDevice() && name.hasPrefix("AtollMixer-") { continue }
